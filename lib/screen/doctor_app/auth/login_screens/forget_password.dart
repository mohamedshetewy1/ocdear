...
import 'package:ocdear/screen/doctor_app/auth/login_screens/enter_code.dart';
...
class ForgetPasswordDoctor extends StatefulWidget {
  ...
  @override
  State<ForgetPasswordDoctor> createState() => _ForgetPasswordState();
}

class _ForgetPasswordState extends State<ForgetPasswordDoctor> {
                    ...
                    function: () {
                      if (formKey.currentState?.validate() ?? false) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => const EnterCodeDoctor(),
                          ),
                        );
                      }
                    },
